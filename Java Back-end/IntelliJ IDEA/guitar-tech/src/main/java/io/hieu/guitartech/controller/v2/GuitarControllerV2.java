...
@RequestMapping(name = "Guitar Controller", path = { "/api/v2/guitars", "/api/v2/guitars.html" })
//@RestController
@Controller
public class GuitarControllerV2 {
    /* Fields */
    private final GuitarServiceV2 guitarServiceV2;

    @Autowired
    public GuitarControllerV2(GuitarServiceV2 guitarServiceV2) {
    ...
    @ResponseBody
    @GetMapping(path = { "/{guitarId}", "/{guitarId}/" })
    ...
    @ResponseBody
    @DeleteMapping(path = { "/{guitarId}", "/{guitarId}/" })
